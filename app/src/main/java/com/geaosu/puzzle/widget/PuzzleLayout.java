package com.geaosu.puzzle.widget;
...
import com.geaosu.puzzle.bean.ImagePiece;
...
public class PuzzleLayout extends FrameLayout implements View.OnClickListener {
    ...
    public static final String GAME_MODE_NORMAL = "gameModeNormal";         // 普通模式
    public static final String GAME_MODE_EXCHANGE = "gameModeExchange";     // 交换模式
    ...
    private int res = R.mipmap.jsx_013;
    ...
    public void onClick(View v) {
        ...
        if (GAME_MODE_NORMAL.equals(mGameMode)) {
            ...
            if (mFirst == null) {
                mFirst = (ImageView) v;
                //选中之后添加一层颜色
                mFirst.setColorFilter(Color.parseColor("#AB000000"));
            } else {
                mSecond = (ImageView) v;
                exChangeView();
            }
...
//        final int secondIndex = mImagePieces.get(mFirst.getId()).getIndex();
    ...
    private void playSound() {
        MusicUtils.getDefault(getContext()).plarMusic();
    }
}
